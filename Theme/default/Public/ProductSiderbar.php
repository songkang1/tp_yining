...
<div class="col-md-2  col-xs-2 sider-bar" style=" padding:5px; width:240px;
     background-image: url(<?php echo v_theme_url() ?>/img/product_category_bg_<?php echo LANG_SET;?>.png);
    ...
    <div class="siderbar" >
        ...
        <ul id="accordion" class="accordion col-md-12">
            ...
            foreach ($categorylist as $value) {
                ...
                ?>
                <li <?php echo $class; ?>>
                    <div class="link"><?php echo $value['name']; ?><i class="fa fa-chevron-down"></i></div>
                    <ul class="submenu ">
                        <?php
                        foreach ($value['childs'] as $childs) {
                            ...
                            ?>
                        <li><a <?php echo $class;?> href="<?php echo U("Product/Index/Index/category/" . $childs['id']); ?>"><?php echo $childs['name']; ?></a></li>
                            <?php
                        }
                        ?>
        ...
        foreach ($categorylist as $value) {
            ...
            echo '<li ><b><a  href="' . U("Product/Index/Index/category/" . $value['id']) . '">' . $value['name'] . '</a></b></li>';
            foreach ($value['childs'] as $childs) {
                $class = "";
                if ($currcategory["id"] == $childs["id"]) {
                ...
                echo '<li class="sub-nav" ><a ' . $class . ' href="' . U("Product/Index/Index/category/" . $childs['id']) . '">' . $childs['name'] . '</a></li>';
            }
        }
        ?> 
                </ul>-->
