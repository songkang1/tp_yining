        ...
        <div class="col-xs-12">
            <div class="curr_page">
                ...
                foreach ($corklist['corklist'] as $v) {
                    $isnull = false;
                    ?>
                                          <!--            <div class="skillbar clearfix col-md-12" data-percent="<?php echo $v['votecount'] / $corklist['votecount']; ?>%">
                                                          <div class="skillbar-title col-md-2" style="background: #2c3e50;"><span><?php echo $v['name'] ?></span></div>
                                                          <div class="skillbar-bar" style="background: #2c3e50;"></div>
                                                          <div class="skill-bar-percent"><?php echo $v['votecount'] / $corklist['votecount']; ?>%</div>
                    -->
                    <div class="col-xs-6">
                        <div class="thumbnail">
                      ...
                      <!--        <h3><?php echo $v['title'] ?></h3>
                              <p><div style="overflow:auto;word-wrap:break-word; word-break:break-all;OVERFLOW-Y:auto; OVERFLOW-X:hidden; max-height: 200px;"  class="col-md-10" ><?php echo $v['summary'] ?></div></p>-->

                                <!--<a href="#" class="btn btn-primary" role="button">Button</a>--> 
                                <a class="btn btn-success btn-block" data-toggle="modal"   onclick="details(<?php echo $v['id'] ?>)"><small>DETAILS</small></a>
    ...
    function vote(corkid) {
        ...
        if (!<?php echo $userinfo->subscribe ? "true" : "false"; ?>) {
            ...
            $.ajax({
                ...
                type: "GET",
                //提交的网址
                url: '<?php echo v_site_url() ?>?m=Cork&a=vote&corkid=' + corkid + '&voteopenid=<?php echo $userinfo->openid ?>',
                //提交的数据
                // data: {corkid: $("#vote").data("corkid"), voteopenid: "<?php echo $userinfo->openid ?>"}, //{Name: "sanmao", Password: "sanmaoword"},
                //返回数据的格式
...
<script>
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            title: '创意橡木塞活动 - 大奖等着你',
            desc: '', // 分享描述
            link: '<?php echo v_site_url() . "/?s=/Home/Oauth2/index/type/corklist" ?>',
            imgUrl: 'http://demo.open.weixin.qq.com/jssdk/images/p2166127561.jpg',
